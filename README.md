...
### 三、DOI10.1109/TPAMI.2025.3535960
### 四、作者团队/机构：
### 五、开源代码链接：https://github.com/Daniel-xsy/RoboBEV
...
4.3 鲁棒性指标
使用nuScenes指标（NDS、mAP等）。引入平均损坏误差 (mCE) 用于相对鲁棒性比较（以DETR3D为基线），和平均恢复率 (mRR) 用于与干净数据集的性能差距。
